		  ...
		  <div className="landing" style={{ backgroundColor: "transparent" }}>
			...
			<button
			  ...
			  style={{
				...
				background: themeColors[theme_color],
				display: "flex",
				alignItems: "center",
				padding: "5px",
			  ...
			  >
				...
				<svg
				  ...
				  style={{
					...
					marginRight: "12px",
					marginLeft: "auto",
					transform: menuVisible ? "rotateX(180deg)" : "rotateX(0deg)", // apply rotation based on menuVisible state
				  }}
				  width="24"
				  height="15"
				  viewBox="0 0 24 15"
